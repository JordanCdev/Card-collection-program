...
{
    public partial class UltimateMonsters : Form
    {
        ...
        BindingSource bs;
        public UltimateMonsters()
        {
            InitializeComponent();
        }

        private void UltimateMonsters_Load(object sender, EventArgs e)
        {
            string pullData = "SELECT cardNumber, cardTitle, rarity FROM UltimateMonsters WHERE owned=false ORDER BY rarity DESC, cardNumber ASC";
            string owned = "SELECT owned FROM UltimateMonsters";
        ...
        private void UltimateMonsters_FormClosing(object sender, FormClosingEventArgs e)
        {
            Application.Exit();
        }
    }
